...
public:
    ...
    *@return  Error code
	 ...
	 *@return  Error code
	 */	 
	errno_t  NewSplinePoint(JointPos *joint_pos, DescPose *desc_pos, int tool, int user, float vel, float acc, float ovl, float blendR, uint8_t lastFlag);
    ...
    *@return  Error code
	...
	/**
	*@brief  Inverse kinematics solution, refer to the specified joint position to determine whether there is a solution
    *@param  [in] desc_pos Cartesian pose
    *@param  [in] joint_pos_ref Reference joint position
    ...
    *@return  Error code
	...
	/**
	 * @brief  Set forces and torques in trajectory runs
	 ...
	 * @param  [in] fz Force along the x direction, unit N
	 * @return  Error code
	 */		
	...
	/**
	 * @brief  Set the torque around the x-axis during trajectory operation
	 * @param  [in] tz Torque around the z-axis in Nm
	 * @return  Error code
	 */		
    ...
    *@return  Error code
	...
	/**
    *@brief  Configure the gripper
    *@param  [out] company  Claw manufacturer, to be determined
    ...
    *@param  [out] bus The device is attached to the terminal bus and is not in use. The default value is 0
    *@return  Error code
	 */
    ...
    *@return  Error code
	 ...
	 *@param  [out] pre_pos  Prefetch point
	 *@return  Error code 
	 */
    ...
    *@param  [out] company  Force sensor manufacturer, to be determined
    *@param  [out] device  Device number, not used yet. The default value is 0
    *@param  [out] softvesion  Software version. The value is not used. The default value is 0
    *@param  [out] bus The device is attached to the terminal bus and is not in use. The default value is 0
    *@return  Error code
    ...
    *@return  Error code
	 ...
	 * @param [in] joint_pos joint position
	 * @param [in] t The sampling period
	 * @return Error code
	 */
	...
	/**
	 * @brief Drive belt starts and stops
	 ...
	 * @return Error code
	 */
	errno_t ConveyorSetParam(float para[5]);

	/**
	 * @brief Drive belt grab point compensation
